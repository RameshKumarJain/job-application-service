...
import com.ideacrest.hireup.resource.AggregateGraphQLResource;
import com.ideacrest.hireup.resource.GraphQLResource;
import com.ideacrest.hireup.resource.JobApplicationResource;
...
public class APIApplication extends Application<APIConfiguration> {
	...
	public void initialize(Bootstrap<APIConfiguration> bootstrap) {
		// Initialise zipkin
		bootstrap.addBundle(new ZipkinBundle<APIConfiguration>("job-application-service") {
			@Override
	...
	public void run(APIConfiguration configuration, Environment environment) throws Exception {
		...
		// register resources
		environment.jersey().register(injector.getInstance(JobApplicationResource.class));
		environment.jersey().register(injector.getInstance(GraphQLResource.class));
		environment.jersey().register(injector.getInstance(AggregateGraphQLResource.class));
	}
